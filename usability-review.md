...
| Check | Status |
|---|---|
| name = `@lucien/openclaw-lark-extended` | ✓ |
| version = `0.1.0` | ✓ |
...
The npm package is `@lucien/openclaw-lark-extended` but the channel id stays
...
- Renames cleanly to `@lucien/openclaw-lark-extended` v0.1.0 and is
